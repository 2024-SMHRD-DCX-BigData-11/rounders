		...
		<div id="warp2">
			<div class='team_wrap01'>
				<div class='team_board'>
					<a href="KiaTeamPage.jsp"> <img src="./image/kia.svg" alt="기아로고" id="kia">
					</a>
				</div>
				<div class='team_board'>
					<a href="SamsungTeamPage.jsp"> <img src="./image/samsung.svg" alt="삼성로고"
						id="samsung">
					</a>
				</div>
				<div class='team_board'>
					<a href="LotteTeamPage.jsp"> <img src="./image/lotte.svg" alt="롯데로고" id="lotte">
					</a>
				</div>
				<div class='team_board'>
					<a href="NcTeamPage.jsp"> <img src="./image/nc.svg" alt="엔씨로고" id="nc">
					</a>
				</div>
				<div class='team_board'>
					<a href="KtTeamPage.jsp"> <img src="./image/kt.svg" alt="케이티로고" id="kt">
					</a>
				</div>
			</div>
			...
			<div class='team_wrap02'>
				<div class='team_board'>
					<a href="HanwhaTeamPage.jsp"> <img src="./image/hanwha.svg" alt="한화로고"
						id="hanwha">
					</a>
				</div>
				<div class='team_board'>
					<a href="KiwoomTeamPage.jsp"> <img src="./image/kiwoom.svg" alt="키움로고"
						id="kiwoom">
					</a>
				</div>
				<div class='team_board'>
					<a href="DoosanTeamPage.jsp"> <img src="./image/doosan.svg" alt="두산로고"
						id="doosan">
					</a>
				</div>
				<div class='team_board'>
					<a href="LgTeamPage.jsp"> <img src="./image/lg.svg" alt="엘지로고" id="lg">
					</a>
				</div>
				<div class='team_board'>
					<a href="SsgTeamPage.jsp"> <img src="./image/ssg.svg" alt="에스에스지로고" id="ssg">
					</a>
				</div>
			</div>
		</div>
