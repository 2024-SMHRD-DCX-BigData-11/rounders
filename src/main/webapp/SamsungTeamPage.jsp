...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			...
			<div class="right">
				...
				<!-- 버튼 -->
				<div class="rightone">
					<input style="background: #074ca1" type="button" value="응원하기" onclick="openPopup()">
				</div>
			</div>
		</div>
	<div class = "write_wrap">
		...
		<%MemberDTO mem_login = (MemberDTO)session.getAttribute("login_member");
			if(mem_login == null){%>
				<a href="Login.jsp"><input style="background: #074ca1" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}else if(mem_login != null){%>
				<a href="TeamPostingWrite.jsp"><input style="background: #074ca1" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}%>
			</div>
	</div>
	<div class = "page_wrap">
		...
		<div class="popup" id="popup">
			...
			<div>팀 응원가</div>
			<div>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/ciNNnn7corY?si=cUNtg7nXLMQXVIeN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
			</div>
