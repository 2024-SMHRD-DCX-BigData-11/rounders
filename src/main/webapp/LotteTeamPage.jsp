...
<body>
<%List<TeamBoardDTO> showLotteBoard = new BoardDAO().showLotteBoard();
MatchDTO mymatch = new MatchDAO().myView(8);
...
if(category.equals("전체")){
	...
	showLotteBoard = new BoardDAO().showKiaBoard();
}else if(category.equals("잡담")){
	category = "잡담";
	System.out.println(category);
	TeamBoardDTO myboard= new TeamBoardDTO(category,8);
	showLotteBoard = new BoardDAO().selectTeamBoardCategory(myboard);
}
...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			<h1>
				롯데 자이언츠 게시판 <select name = "board_category" onchange="if(this.value) location.href=(this.value);">
			...
			<span style="color: red">!! 지금 핫한 게시물 !! >>></span>
				...
				<%for(TeamBoardDTO tb : showLotteBoard){%>
	...
	<div class = "write_wrap">
		...
		<%}else if(mem_login != null && team_idx == 8){%>
