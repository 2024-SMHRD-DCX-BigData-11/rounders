...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			...
			<div class="right">
				<div class="rightone">
					<table id="schedule_wrap" style="border: 3px solid #131230">
						<tr>
	...
	<div class = "write_wrap">
		...
		<%MemberDTO mem_login = (MemberDTO)session.getAttribute("login_member");
			if(mem_login == null){%>
				<a href="Login.jsp"><input style="background: #131230" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}else if(mem_login != null){%>
				<a href="TeamPostingWrite.jsp"><input style="background: #131230" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}%>
			</div>
	</div>
	<div class = "page_wrap">
