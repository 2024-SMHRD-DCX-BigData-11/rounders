...
if(category.equals("전체")){
	...
	showDoosanBoard = new BoardDAO().showKiaBoard();
}else if(category.equals("잡담")){
	category = "잡담";
	System.out.println(category);
	TeamBoardDTO myboard= new TeamBoardDTO(category,4);
	showDoosanBoard = new BoardDAO().selectTeamBoardCategory(myboard);
}
...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			<h1>
				두산 베어스 게시판 <select name = "board_category" onchange="if(this.value) location.href=(this.value);">
							<option value="카테고리">카테고리</option>
							<option value="DoosanTeamPage.jsp?category=전체">전체</option>
							<option value="DoosanTeamPage.jsp?category=잡담">잡담</option>
							<option value="DoosanTeamPage.jsp?category=정보">정보</option>
							<option value="DoosanTeamPage.jsp?category=직관모임">직관모임</option>
				</select>
			</h1>
			<table class="table">
			...
			<div class="right">
				...
				<!-- 버튼 -->
				<div class="rightone">
					<input style="background:#131230" type="button" value="응원하기" onclick="openPopup()">
				</div>
			</div>
		</div>
	<div class = "write_wrap">
		...
		<%}else if(mem_login != null && team_idx == 4){%>
	...
	<div class = "page_wrap">
		...
		<div class="popup" id="popup">
			...
			<div>팀 응원가</div>
			<div>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/dqW2DaOjOho?si=SLL1waa9maKuuiUb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
			</div>
			<a target="_blank" href="https://ticket.interpark.com/contents/Promotion/Event/MDShopList?dispNo=001780002008"><img
				id="logo" src="./image/doosan.svg"></a> <span><< 굿즈 사러가기 </span> <span
				style="color: red">CLICK!</span>
			<button style="background: #131230" onclick="closePopup()">닫기</button>
		</div>
