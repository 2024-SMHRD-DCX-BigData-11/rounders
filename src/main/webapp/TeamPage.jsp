...
<body>
	...
	<div id="team">
		...
		<div class="write">
			<input type="button" name="write" value="글 쓰기" id="write">
		</div>
		<div class="page">
			<a href="#">1</a>
			<a href="#">2</a>
			...
			<a href="#">9</a>
			<a href="#">10</a>
			<a href="#" class="next" title="다음"><input type="button"name="next" value="다음"></a>
		</div>
...
<div class="popup" id="popup">
  ...
  <div>팀 응원가</div>
  <div>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/cGs5swSDvJ8?si=7xh4_WbYPHFuOThA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  </div>
  <a target="_blank" href="https://teamstore.tigers.co.kr/"><img id="logo" src="./image/kia.svg"></a>
  <span><< 굿즈 사러가기 </span>
