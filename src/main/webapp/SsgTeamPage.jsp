...
if(category.equals("전체")){
	...
	showSsgBoard = new BoardDAO().showKiaBoard();
}else if(category.equals("잡담")){
	category = "잡담";
	System.out.println(category);
	TeamBoardDTO myboard= new TeamBoardDTO(category,5);
	showSsgBoard = new BoardDAO().selectTeamBoardCategory(myboard);
}
...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			<h1>
				SSG 랜더스 게시판 <select name = "board_category" onchange="if(this.value) location.href=(this.value);">
							<option value="카테고리">카테고리</option>
							<option value="SsgTeamPage.jsp?category=전체">전체</option>
							<option value="SsgTeamPage.jsp?category=잡담">잡담</option>
							<option value="SsgTeamPage.jsp?category=정보">정보</option>
							<option value="SsgTeamPage.jsp?category=직관모임">직관모임</option>
				</select>
			</h1>
			<table class="table">
			...
			<div class="right">
				...
				<!-- 버튼 -->
				<div class="rightone">
					<input style="background: #ce0e2d" type="button" value="응원하기" onclick="openPopup()">
				</div>
			</div>
		</div>
	...
	<div class = "page_wrap">
		...
		<div class="popup" id="popup">
			...
			<div>팀 응원가</div>
			<div>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/WlMujqD6EYs?si=y2Z1TLzMR4ji2e-w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
			</div>
			<a target="_blank" href="https://ssglanderseshop.co.kr/"><img
				id="logo" src="./image/ssg.svg"></a> <span><< 굿즈 사러가기 </span> <span
				style="color: red">CLICK!</span>
			<button style="background: #ce0e2d" onclick="closePopup()">닫기</button>
		</div>
