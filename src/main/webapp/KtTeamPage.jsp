...
if(category.equals("전체")){
	...
	showKtBoard = new BoardDAO().showKiaBoard();
}else if(category.equals("잡담")){
	category = "잡담";
	System.out.println(category);
	TeamBoardDTO myboard= new TeamBoardDTO(category,9);
	showKtBoard = new BoardDAO().selectTeamBoardCategory(myboard);
}
...
<div class = "wrap">
	...
	<div class = "write_wrap">
		...
		<%}else if(mem_login != null && team_idx == 9){%>
