...
<head>
<meta charset="UTF-8">
<title>KT 팀 페이지</title>
	<link href="./css/TeamPage.css" rel="stylesheet" type="text/css">
</head>
<body>
<%List<TeamBoardDTO> showKtBoard = new BoardDAO().showKtBoard();%>
<%@ include file="header.jsp"%>
<div class="container">
	<img alt="logo" src="./image/ktimg.jpg" class="img">
		<div id="smhrd">
			<div id="sm_logo">
...
<div class = "wrap">
	<div class="all">
		...
		<div  id="team">
			...
			<span style="color: red">!! 지금 핫한 게시물 !! >>></span>
				...
				<%for(TeamBoardDTO tb : showKtBoard){%>
			...
			<div class="right">
				<div class="rightone">
					<table id="schedule_wrap" style="border: 3px solid #000000">
						<tr>
				...
				<!-- 버튼 -->
				<div class="rightone">
					<input style="background: #000000" type="button" value="응원하기" onclick="openPopup()">
				</div>
			</div>
		</div>
	<div class = "write_wrap">
		...
		<%MemberDTO mem_login = (MemberDTO)session.getAttribute("login_member");
			if(mem_login == null){%>
				<a href="Login.jsp"><input style="background: #000000" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}else if(mem_login != null){%>
				<a href="TeamPostingWrite.jsp"><input style="background: #000000" type="button" name="write" value="글 쓰기" id="write"></a>
				<%}%>
			</div>
	</div>
	<div class = "page_wrap">
		...
		<div class="popup" id="popup">
			...
			<div>팀 응원가</div>
			<div>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/TiZOu5M3Zdk?si=wMQR0hrgNKDufNwI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
			</div>
			<a target="_blank" href="https://www.ktwizstore.co.kr/"><img
				id="logo" src="./image/kt.svg"></a> <span><< 굿즈 사러가기 </span> <span
				style="color: red">CLICK!</span>
			<button style="background: #000000" onclick="closePopup()">닫기</button>
		</div>
