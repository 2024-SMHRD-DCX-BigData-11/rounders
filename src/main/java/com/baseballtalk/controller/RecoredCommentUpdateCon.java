...
@WebServlet("/RecoredCommentUpdateCon")
	
	public class RecoredCommentUpdateCon extends HttpServlet {
		...
		request.setCharacterEncoding("UTF-8");
			...
			int u_cnt = new CommentDAO().updateRecoredComment(recoredComment);
