...
@WebServlet("/RecoredCommentInsertCon")
	
	public class RecoredCommentInsertCon extends HttpServlet {
		...
		request.setCharacterEncoding("UTF-8");
			...
			RecoredCommentDTO recoredComment = new RecoredCommentDTO(rcmt_content, mem_id);
